...
# setwd('D:/ZZZ/Manuscripts/Image_Gene/Gradient_test/Lifespan_new/Results/NDI/BP/NDI_Neg_ALL_GO/Enrichment_heatmap')
...
# setwd('D:/ZZZ/Manuscripts/Image_Gene/Gradient_test/Lifespan_new/Results/NDI/BP/NDI_Pos_ALL_GO/Enrichment_heatmap')
# gene_ref<-read.csv('HeatmapSelectedGOTop100.csv',header=TRUE)
...
# setwd('D:/ZZZ/Manuscripts/Image_Gene/Gradient_test/Lifespan_new/Results/Lesion_volume/BP/Multi_gene_list_PLS_Neg_GO/Enrichment_heatmap')
# gene_ref<-read.csv('HeatmapSelectedGOTop100.csv',header=TRUE)
...
setwd('D:/ZZZ/Manuscripts/Image_Gene/Gradient_test/Lifespan_new/Results/Lesion_volume/BP/Multi_gene_list_PLS_Pos_GO/Enrichment_heatmap')
gene_ref<-read.csv('HeatmapSelectedGOTop100.csv',header=TRUE)
...
#dev.off()
setwd(savepath);
ggsave(paste0(Str,"_Rplot01.pdf"),p,device = cairo_pdf,width=30,height=12,units='cm')